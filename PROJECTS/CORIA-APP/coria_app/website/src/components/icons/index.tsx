...
export function ChatBubbleLeftRightIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
// Export all CORIA custom icons from coria-icons.tsx
export {
  CoriaFoundationIcon,
  VeganAnalysisIcon,
  AIAssistantIcon,
  ...
  GreenEnergyIcon,
  SustainabilityIcon,
  // New Custom Icons - yeni-tasarım.md v2.0
  LeafIcon,
  CarbonIcon,
  WaterIcon,
  HeartIcon,
...
// Export all SVG icons from svg-icons.tsx
export {
  AIAssistantSvgIcon,
  SmartPantrySvgIcon,
  CommunitySvgIcon,
